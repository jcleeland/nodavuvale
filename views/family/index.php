<section class="hero bg-deep-green text-white py-20">
    <div class="container hero-content">
        <h2 class="text-4xl font-bold">Soli Nataleira's Lost Children</h1>
        <p class="mt-4 text-lg">Establishing and sharing the genealogy of Soli's descendents.</p>
    </div>
</section>
...
<section class="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="p-6 bg-white shadow-lg rounded-lg">
            ...
            <p class="mt-2">Read stories from across the generations and contribute your own tales.</p>
            <a href="?to=family/stories" class="mt-4 inline-block text-blue-600 hover:text-blue-800">Share a Story</a>
        </div>
    </div>
</section>
