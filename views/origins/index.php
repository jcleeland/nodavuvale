<section class="hero bg-deep-green text-white py-20">
    <div class="container hero-content">
        <h2 class="text-4xl font-bold">Our origin stories</h1>
        <p class="mt-4 text-lg">"I am one with my ancestors and my descendants. I am life manifesting in countless different forms."<br /><i>Thich Nhat Hanh (Buddhist Monk)</i></p>
    </div>
</section>
...
<section class="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
    <div class="text-center mb-8">
        <p class="mt-4 text-lg">
            The stories of our ancestors are the foundation of our family. They are the roots that ground us and the branches that reach out to the future. 
            Through these stories, we learn about the lives of those who came before us, the challenges they faced, and the triumphs they celebrated.
        </p>
        <p class="mt-4 text-lg">
            We honour their memory by sharing their stories and passing them on to the next generation.
        </p>
    </div>
