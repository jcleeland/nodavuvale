...
<section class="hero bg-cover bg-center py-24">
    <div class="container hero-content mx-auto text-center text-white">
        <h1 class="text-5xl font-bold mb-4">Nataleira Village</h1>
        <p class="text-xl max-w-xl mx-auto leading-relaxed">
            Discover the rich history and cultural heritage of Nataleira
        </p>
...
<section class="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
    ...
    <p class="text-lg leading-relaxed mb-6">
        ...
        <ul class="mb-6 rounded-lg ml-6 pl-2">
            <li class="hover:bg-gray-200"><a href='https://www.nzherald.co.nz/travel/room-check-sustainable-comfort-and-simplicity-in-the-heart-of-fijis-rural-wilderness/RIUWAGAHEJD6ZKGJKM3SAQWEYE/' target='_blank'>NZ Herald Travel review</a></li>
            <li class="hover:bg-gray-200"><a href='https://www.fijitimes.com.fj/eco-friendly-getaway/' target='_blank'>Fiji Times Review</a></li>
        </ul>
    </p>
